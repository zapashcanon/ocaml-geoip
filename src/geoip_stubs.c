...
value camlidl_c2ml_geoip_t(t *_c2, camlidl_ctx _ctx) {
  value _v1;
  _v1 = camlidl_alloc((sizeof(t) + sizeof(value) - 1) / sizeof(value),
                      Abstract_tag);
  *((t *)Bp_val(_v1)) = *_c2;
  return _v1;
}
...
value camlidl_c2ml_geoip_enum_charset(int _c1) {
  ...
  case GEOIP_CHARSET_UTF8:
    ...
    break;
  default:
    caml_invalid_argument("enum charset: bad enum charset value");
  }
  return _v2;
}

int camlidl_transl_table_geoip_enum_2[5] = {
    GEOIP_STANDARD,    GEOIP_MEMORY_CACHE, GEOIP_CHECK_CACHE,
    GEOIP_INDEX_CACHE, GEOIP_MMAP_CACHE,
};
...
value camlidl_c2ml_geoip_enum_flags(int _c1) {
  value _v2;
  _v2 = camlidl_find_enum(_c1, camlidl_transl_table_geoip_enum_2, 5,
                          "enum flags: bad enum flags value");
  return _v2;
}
...
value camlidl_c2ml_geoip_enum_db_type(int _c1) {
  value _v2;
  _v2 = camlidl_find_enum(_c1, camlidl_transl_table_geoip_enum_3, 18,
                          "enum db_type: bad enum db_type value");
  return _v2;
}
...
value camlidl_c2ml_geoip_enum_proxy_type(int _c1) {
  ...
  case GEOIP_ANON_PROXY:
    _v2 = Val_int(0);
    break;
  case GEOIP_HTTP_X_FORWARDED_FOR_PROXY:
    _v2 = Val_int(1);
    break;
  case GEOIP_HTTP_CLIENT_IP_PROXY:
    _v2 = Val_int(2);
    break;
  default:
    caml_invalid_argument("enum proxy_type: bad enum proxy_type value");
  }
  return _v2;
}
...
value camlidl_c2ml_geoip_enum_netspeed(int _c1) {
  ...
  case GEOIP_CORPORATE_SPEED:
    ...
    break;
  default:
    caml_invalid_argument("enum netspeed: bad enum netspeed value");
  }
  return _v2;
}

value camlidl_geoip_GeoIP_setup_custom_directory(value _v_dir) {
  char *dir; /*in*/
...
value camlidl_geoip_GeoIP_db_avail(value _v_type) {
  int type; /*in*/
  int _res;
  value _vres;
...
value camlidl_geoip_GeoIP_delete(value _v_gi) {
  t gi; /*in*/
...
value camlidl_geoip_GeoIP_country_code_by_addr(value _v_gi, value _v_addr) {
  t gi;             /*in*/
  char const *addr; /*in*/
  char const *_res;
  value _v1;
  ...
  if (_res == NULL) {
    ...
    _v1 = caml_copy_string(_res);
    Begin_root(_v1) _vres = camlidl_alloc_small(1, 0);
    Field(_vres, 0) = _v1;
    End_roots();
  }
  camlidl_free(_ctx);
...
value camlidl_geoip_GeoIP_country_code_by_name(value _v_gi, value _v_host) {
  t gi;             /*in*/
  char const *host; /*in*/
  char const *_res;
  value _v1;
...
value camlidl_geoip_GeoIP_country_code3_by_addr(value _v_gi, value _v_addr) {
  t gi;             /*in*/
  char const *addr; /*in*/
  char const *_res;
  value _v1;
...
value camlidl_geoip_GeoIP_country_code3_by_name(value _v_gi, value _v_host) {
  t gi;             /*in*/
  char const *host; /*in*/
  char const *_res;
  value _v1;
...
value camlidl_geoip_GeoIP_country_name_by_addr(value _v_gi, value _v_addr) {
  t gi;             /*in*/
  char const *addr; /*in*/
  char const *_res;
  value _v1;
...
value camlidl_geoip_GeoIP_country_name_by_name(value _v_gi, value _v_host) {
  t gi;             /*in*/
  char const *host; /*in*/
  char const *_res;
  value _v1;
...
value camlidl_geoip_GeoIP_country_name_by_ipnum(value _v_gi, value _v_ipnum) {
  t gi;                /*in*/
...
value camlidl_geoip_GeoIP_country_code_by_ipnum(value _v_gi, value _v_ipnum) {
  t gi;                /*in*/
  unsigned long ipnum; /*in*/
  char const *_res;
  value _v1;
...
value camlidl_geoip_GeoIP_country_code3_by_ipnum(value _v_gi, value _v_ipnum) {
  t gi;                /*in*/
  unsigned long ipnum; /*in*/
  char const *_res;
  value _v1;
...
value camlidl_geoip_GeoIP_country_code_by_addr_v6(value _v_gi, value _v_addr) {
  t gi;             /*in*/
  char const *addr; /*in*/
  char const *_res;
  value _v1;
...
value camlidl_geoip_GeoIP_country_code_by_name_v6(value _v_gi, value _v_host) {
  t gi;             /*in*/
  char const *host; /*in*/
  char const *_res;
  value _v1;
...
value camlidl_geoip_GeoIP_country_code3_by_addr_v6(value _v_gi, value _v_addr) {
  t gi;             /*in*/
  char const *addr; /*in*/
  char const *_res;
  value _v1;
...
value camlidl_geoip_GeoIP_country_code3_by_name_v6(value _v_gi, value _v_host) {
  t gi;             /*in*/
  char const *host; /*in*/
  char const *_res;
  value _v1;
...
value camlidl_geoip_GeoIP_country_name_by_addr_v6(value _v_gi, value _v_addr) {
  t gi;             /*in*/
  char const *addr; /*in*/
  char const *_res;
  value _v1;
...
value camlidl_geoip_GeoIP_country_name_by_name_v6(value _v_gi, value _v_host) {
  t gi;             /*in*/
  char const *host; /*in*/
  char const *_res;
  value _v1;
...
value camlidl_geoip_GeoIP_id_by_addr(value _v_gi, value _v_addr) {
  t gi;             /*in*/
  char const *addr; /*in*/
  int _res;
  value _vres;
...
value camlidl_geoip_GeoIP_id_by_name(value _v_gi, value _v_host) {
  t gi;             /*in*/
  char const *host; /*in*/
  int _res;
  value _vres;
...
value camlidl_geoip_GeoIP_id_by_ipnum(value _v_gi, value _v_ipnum) {
  t gi;                /*in*/
  unsigned long ipnum; /*in*/
  int _res;
  value _vres;
...
value camlidl_geoip_GeoIP_id_by_addr_v6(value _v_gi, value _v_addr) {
  t gi;             /*in*/
  char const *addr; /*in*/
  int _res;
  value _vres;
...
value camlidl_geoip_GeoIP_id_by_name_v6(value _v_gi, value _v_host) {
  t gi;             /*in*/
  char const *host; /*in*/
  int _res;
  value _vres;
...
value camlidl_geoip_GeoIP_database_info(value _v_gi) {
  t gi; /*in*/
  char *_res;
  value _vres;
...
value camlidl_geoip_GeoIP_database_edition(value _v_gi) {
  t gi; /*in*/
  unsigned int _res;
  value _vres;
...
value camlidl_geoip_GeoIP_charset(value _v_gi) {
  t gi; /*in*/
  int _res;
  value _vres;
...
value camlidl_geoip_GeoIP_set_charset(value _v_gi, value _v_charset) {
  t gi;        /*in*/
  int charset; /*in*/
  int _res;
  value _vres;
